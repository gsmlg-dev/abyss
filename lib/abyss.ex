defmodule Abyss do
  ...
  supervising the Abyss process tree, applications interact with Thousand
  Island primarily via the `Abyss.Handler` behaviour.
  ...
  Abyss.Acceptor processes to shut down as well. At this point all that
  ...
  * `transport_module`: The name of the module which provides basic socket functions.
  Abyss provides `Abyss.Transports.TCP` and `Abyss.Transports.SSL`,
  ...
  * `transport_options`: A keyword list of options to be passed to the transport module's
  ...
  `Abyss.Transports.TCP` and `Abyss.Transports.SSL` modules. Any options
  ...
  * `silent_terminate_on_error`: Whether to silently ignore errors returned by the handler or to
  ...
  @type transport_module :: Abyss.Transports.UDP | Abyss.Transports.TCP | Abyss.Transports.SSL

  @typedoc "A keyword list of options to be passed to the transport module's `listen/2` function"
  @type transport_options() ::
          Abyss.Transports.UDP.options()
          | Abyss.Transports.TCP.options()
          | Abyss.Transports.SSL.options()
