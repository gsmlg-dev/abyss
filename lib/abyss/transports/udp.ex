defmodule Abyss.Transports.UDP do
  ...
  is defined via the `t::gen_udp.listen_option/0` type. This list can be somewhat
  ...
  * `ip`:  The IP to listen on. Can be specified as:
  ...
  def listen(port, user_options) do
    ...
    Logger.debug(inspect({:gen_udp, :open, port, resolved_options}))
